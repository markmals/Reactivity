...
```md
**As a** [real user persona] **I want** [capability the user performs] **So that** [user-visible outcome or value]
```
...
**Don't:** "System writes CSV file to S3" **Do:** "The user can download their data as a CSV file"
...
**Don't:** `Given the user clicks the export button` **Do:** `Given the user is signed in` / `Given the user has recorded transactions`
...
**Don't:** `When the user clicks the green export button in the top right` **Do:** `When the user requests a data export`

**Don't:** `When I open the Share dialog and type Jordan's email into the recipient field` **Do:** `When I share the document with Jordan`
...
**As a** signed-in customer **I want** to download my transaction history **So that** I can keep my own records and use the data in other tools.
