...
<!--
  ...
  Each scenario sub-ID rides on a Swift Testing trait (see specs/CONVENTIONS.md):
  @Suite(.spec("story.<feature>.<capability>"))
  @Test(.scenario("scenario.<feature>.<capability>.<short-name>"))
